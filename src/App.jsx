...
export default class App extends Component {
  ...
  componentDidMount() {
    ...
    firebase.storage().ref('68CF3EC0-3DA1-41AF-943E-0DF3820C4467.jpeg').getDownloadURL().then(res =>{
  ...
  validateForm = (name,amount) => {
    if (!name || !amount) {
      ...
      window.alert('Please fill Integer in Amount field.');
      return false;
    }else if (+amount === 0) {
  ...
  addTransaction = (name,amount) => {
    ...
    const newTransaction = {
      ...
      name,
      amount: +amount,
      date: new Date().getTime() //addgettime to varidate
    }
